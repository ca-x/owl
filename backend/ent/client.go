...
// QueryOwner queries the owner edge of a Dictionary.
func (c *DictionaryClient) QueryOwner(_m *Dictionary) *UserQuery {
...
// QueryDictionaries queries the dictionaries edge of a User.
func (c *UserClient) QueryDictionaries(_m *User) *DictionaryQuery {
